...
if (isset($_POST["Submit"])) {
		...
		if ($Execute) {
			echo '<script>window.open("Viewdata.php?id=Record Deleted succesfully", "_self")</script>';
		}
}
?>
<!DOCTYPE html>
<html>
<head>
	<title>Delete data into a form</title>
...
<div>
	...
	<form class="" action="Delete.php?id=<?php echo $SearchQueryParameter; ?>" method="POST">
		<fieldset>
			...
			<br>
			<input type="submit" name="Submit" value="Confirm delete record">
		</fieldset>
	</form>
</div>
</body>
